...
Is it possible to find the file based on it's name and not the path ? Yes but it will make the API slower currently working on find the fastest way to do this.